        ...
        <div className="bg-gray-100 rounded-md p-7 shadow-lg">
          ...
          {/*<form action="">*/}
            <div className='relative my-4'>
              <input type="text" className='block w-73 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-[#007b3e] focus:outline-none focus:ring-0 focus:text-black focus:border-[#007b3e] peer' placeholder=''/>
            ...
            <div className='relative my-4'>
              <input type="password" className='block w-73 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-black appearance-none dark:focus:border-[#007b3e] focus:outline-none focus:ring-0 focus:text-black focus:border-[#007b3e] peer' placeholder=''/>
            ...
            */}
            <button onClick={() => navigate('/Principal')} className='w-full mb-4 text-[18px] mt-6 rounded-full bg-emerald-700 text-white hover:bg-emerald-500 hover:text-white py-2 transition-colors duration-300 ' type='submit' >Ingresar</button>
            <div>
