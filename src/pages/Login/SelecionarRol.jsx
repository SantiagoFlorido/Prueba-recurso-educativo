      ...
      <div className="bg-gray-100 rounded-md p-0 shadow-lg ">
        <div className="text-center bg-gray p-8 rounded-lg shadow-lg max-w-2xl w-full bg-gray-100">
          <h1 className='text-4x1 text-[#007B3E] text-[30px] font-bold text-center mb-6'>Selecciona tu rol</h1>
            <button onClick={() => navigate('/Login/Teacher')} className='cursor-pointer w-full mb-4 text-[18px] mt-6 rounded-full bg-[#007B3E] text-white hover:bg-[#009e4f] hover:text-white py-2 transition-colors duration-300 ' type='submit' >Docente</button>
            <button onClick={() => navigate('/Login/Student')} className='cursor-pointer w-full mb-4 text-[18px] mt-6 rounded-full bg-[#007B3E] text-white hover:bg-[#009e4f] hover:text-white py-2 transition-colors duration-300 ' type='submit' >Estudiante</button>
        </div>
      </div>
      </div>
    </div>
