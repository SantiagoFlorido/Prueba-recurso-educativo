...
const Pagina4Informacion6 = () => {
  ...
  useEffect(() => {
    const checkUserTallerRelation = async () => {
      try {
        ...
        const response = await fetch(`https://prueba-api-recurso-educativo-9x4o.onrender.com/api/v1/usuarios-talleres?id_usuario=${currentUser.id}&id_taller=6`);
  ...
  const slides = [
    ...
    },
    {
      ...
      videoUrl: "https://res.cloudinary.com/dufzsv87k/video/upload/v1745966499/TallerVideo6.mp4",
