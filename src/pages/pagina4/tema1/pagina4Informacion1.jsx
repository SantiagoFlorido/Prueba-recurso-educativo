...
const Pagina4Informacion1 = () => {
  ...
  const slides = [
    {
      id: 1,
      image: "https://res.cloudinary.com/dufzsv87k/image/upload/v1741305069/mapa_igu9fc.webp", // Imagen de la interfaz de mBlock
      text: "En este taller, aprenderemos a usar mBlock, una herramienta de programación visual. Conoceremos su interfaz y cómo nos ayuda a programar el mBot.",
    },
    {
      id: 2,
      image: "", // Imagen de coordenadas en mBlock
      text: "Aprenderemos a mover el panda en el escenario usando coordenadas (X, Y). Esto nos ayudará a entender cómo se ubican los objetos en un espacio bidimensional.",
    },
    {
      id: 3,
      image: "", // Imagen de bloques de movimiento
      text: "Programaremos el panda para que se mueva en diferentes direcciones usando bloques como 'Mueve 10 pasos' y 'Gira X grados'.",
    },
    {
      id: 4,
      image: "", // Imagen de bloques de rotación
      text: "Aprenderemos a usar bloques de rotación para crear ángulos y cambiar la dirección del panda. Esto es útil para navegar en el escenario.",
    },
    {
      id: 5,
      image: "", // Imagen de trayectorias de polígonos
      text: "Crearemos trayectorias para el panda que formen polígonos, como triángulos y cuadrados. Esto nos ayudará a entender las propiedades de las figuras geométricas.",
    },
    {
      id: 6,
      image: "", // Imagen del recorrido de Pedro
      text: "En esta actividad, programaremos el panda para que siga la historia de Pedro, visitando a sus amigos y explorando el pueblo. Aplicaremos todo lo aprendido sobre coordenadas y ángulos.",
    },
    {
      id: 7,
      image: "", // Imagen de estudiantes trabajando
