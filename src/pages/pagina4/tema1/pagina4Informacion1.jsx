...
const Pagina4Informacion1 = () => {
  ...
  useEffect(() => {
    const checkUserTallerRelation = async () => {
      try {
        ...
        const response = await fetch(`https://prueba-api-recurso-educativo-9x4o.onrender.com/api/v1/usuarios-talleres?id_usuario=${currentUser.id}&id_taller=1`);
  ...
  const slides = [
    ...
    },
    {
      ...
      videoUrl: "https://res.cloudinary.com/dufzsv87k/video/upload/v1745965936/TallerVideo1.mp4",
